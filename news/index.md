...
- Add
  ...
  function to define relationships between core database tables and
  newly added tables.
...
- Add parameter `nonStop` to `compound_tbl_sdf` that is passed to
  parameter `skipErrors` of
  [`ChemmineR::read.SDFset`](https://rdrr.io/pkg/ChemmineR/man/read.SDFset.html).
  Issue
  [\#110](https://github.com/rformassspectrometry/CompoundDb/issues/110)
...
- Address more comments from [@jianhong](https://github.com/jianhong).
...
- Address comments/change requests from
...
- Add `deleteIon` and `deleteSpectra` allowing to delete ions or
  spectra.
...
- Rename database table name *compound* into *ms_compound*
  [issue](https://github.com/EuracBiomedicalResearch/CompoundDb/issues/74)
  [\#74](https://github.com/RforMassSpectrometry/CompoundDb/issues/74).
...
- Add parameter `onlyValid` to `compound_tbl_sdf` to allow importing of
  only valid elements
  [issue](https://github.com/EuracBiomedicalResearch/CompoundDb/issues/69)
  [\#69](https://github.com/RforMassSpectrometry/CompoundDb/issues/69).

### Changes in version 0.6.4

- Add additional filters: `MassFilter`, `FormulaFilter`, `InchiFilter`
  and `InchikeyFilter`.
...
- Add instrument and precursor_mz spectra data columns (issue
  [\#32](https://github.com/RforMassSpectrometry/CompoundDb/issues/32)).
...
- Change field collision_energy to character to support values from MoNa
  (issue
  [\#31](https://github.com/RforMassSpectrometry/CompoundDb/issues/31)).
- Add functions import_mona_sdf and msms_spectra_mona functions to
  enable import of spectrum data from MoNa SDF files (issue
  [\#30](https://github.com/RforMassSpectrometry/CompoundDb/issues/30)).
- Add support for MoNa SDF files (issue
  [\#30](https://github.com/RforMassSpectrometry/CompoundDb/issues/30)).

### Changes in version 0.2.0

- Add hasMz,Spectrum and hasMz,Spectra methods to look for m/z values
  within spectra (issue
  [\#28](https://github.com/RforMassSpectrometry/CompoundDb/issues/28)).
- Add MsmsMzRangeMinFilter and MsmsMzRangeMaxFilter (issue
  [\#29](https://github.com/RforMassSpectrometry/CompoundDb/issues/29)).
...
- Add precursorMz, precursorCharge, precursorIntensity, acquisitionNum,
  scanIndex, peaksCount, msLevel, tic, ionCount, collisionEnergy,
  fromFile, polarity, smoothed, isEmpty, centroided and isCentroided
  methods for Spectrum2List.
